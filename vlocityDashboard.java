...
public class vlocityDashboard {
    ...
    @FindBy(how=How.CSS , using = "#CMC_ActionsMenu>li>a")
    public  WebElement link_ManageConfig;

    @FindBy(how=How.LINK_TEXT,using = "Manage V-locity License")
    public WebElement link_ManageLicense;
...
public void get_vLocityStatus()
{
    ...
    System.out.println("IntelliWrite Status" + vlocityStatus.get(2).getText());
    System.out.println("FilePerformanceOPtimization" + vlocityStatus.get(3).getText());
}

public void click_ManageConfigLink()
{
    link_ManageConfig.click();
    wait.until(ExpectedConditions.titleContains("V-locity | Configuration Policy"));
    assertTrue(driver.getTitle().contains("V-locity | Configuration Policy"));

}

public void click_ManageLicenseLInk()
{
    link_ManageLicense.click();
    wait.until(ExpectedConditions.titleContains("License Management"));
    assertTrue(driver.getTitle().contains("License Management"));
}
